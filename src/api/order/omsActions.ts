...
export const flowaOrderActionApprove = (p: { sales_order_name: string; company?: string }) =>
  alovaInstance.Post<unknown>('flowa_order_action_approve', p)

export const flowaOrderActionCancel = (p: {
  sales_order_name: string
  company?: string
  cancel_reason: string
}) => alovaInstance.Post<unknown>('flowa_order_action_cancel', p)

export const flowaOrderActionBlock = (p: { sales_order_name: string; company?: string }) =>
  alovaInstance.Post<unknown>('flowa_order_action_block', p)

export const flowaOrderActionMarkPending = (p: { sales_order_name: string; company?: string }) =>
  alovaInstance.Post<unknown>('flowa_order_action_mark_pending', p)

export const flowaOrderActionDuplicateOrder = (p: {
  sales_order_name: string
  company?: string
  new_delivery_date?: string
}) => alovaInstance.Post<unknown>('flowa_order_action_duplicate_order', p)
...
export const flowaOrderActionContactSupport = (p: {
  ...
  message?: string
  priority?: string
}) => alovaInstance.Post<unknown>('flowa_order_action_contact_support', p)
...
export const flowaOrderActionSplitLineToNewOrder = (p: {
  ...
  qty?: number
}) => alovaInstance.Post<unknown>('flowa_order_action_split_line_to_new_order', p)
...
export const flowaOrderActionAddLineItem = (p: {
  ...
  rate?: number
  is_gift?: boolean
}) => alovaInstance.Post<unknown>('flowa_order_action_add_line_item', p)

export const flowaOrderActionUpdateShopifyShipping = (p: {
  sales_order_name: string
  company?: string
  shipping_updates: string
}) => alovaInstance.Post<unknown>('flowa_order_action_update_shopify_shipping_address', p)
