<template>
  <div class="dashboard flex flex-col gap-4">
    ...
    <div>
      ...
      <el-row :gutter="16">
        <el-col :xs="24" :lg="8" class="mb-6 lg:mb-0">
          <div
      ...
      <el-col :xs="24" :sm="12" :lg="15">
        <div class="bg-white rounded-xl action-table overflow-auto p-1">
          <div class="flex items-center justify-between p-2">
            <div class="text-lg font-bold text-#000 text-16px">Action Required</div>
            <el-button type="default" plain class="!rounded-2 !px-4 !py-1.5">
              <Icon icon="hugeicons:share-05" width="24" height="24"  style="color: #16215B" />
